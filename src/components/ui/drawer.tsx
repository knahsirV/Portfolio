  ...
  return (
    <>
      <DrawerPrimitive.Overlay
        ...
        {...props}
      />
      <div className=' fixed inset-0 p-8 z-50 w-full '>
        <div className='flex justify-between font-mono'>
          <Link to='/' className={cn(buttonVariants({ variant: "default" }), "uppercase")}>
            Vrishank Viswanath
          </Link>
          <DrawerClose className={cn(buttonVariants({ variant: "secondary" }), "uppercase")}>
            Back
          </DrawerClose>
        </div>
      </div>
  ...
  return (
    <DrawerPortal data-slot='drawer-portal'>
      ...
      <DrawerPrimitive.Content
        ...
        className={cn(
          "group/drawer-content  fixed z-50  m-8",
        ...
        {...props}
      >
        <div className='rounded-2xl bg-background flex flex-col h-[50vh] p-4 gap-4'>
